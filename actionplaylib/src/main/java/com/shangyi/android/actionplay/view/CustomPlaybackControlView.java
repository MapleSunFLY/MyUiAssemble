    ...
    private void updateNavigation() {
        ...
        if (haveNonEmptyTimeline) {
            ...
            enablePrevious = isSeekable || !window.isDynamic
                    || timeline.getPreviousWindowIndex(windowIndex, player.getRepeatMode(),false) != C.INDEX_UNSET;
            enableNext = window.isDynamic
                    || timeline.getNextWindowIndex(windowIndex, player.getRepeatMode(),false) != C.INDEX_UNSET;
