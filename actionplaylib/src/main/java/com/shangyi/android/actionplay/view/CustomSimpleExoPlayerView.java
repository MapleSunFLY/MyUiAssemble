...
public final class CustomSimpleExoPlayerView extends FrameLayout {
  ...
  public CustomSimpleExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    int playerLayoutId = R.layout.common_simple_exo_view;
    ...
    CustomPlaybackControlView customController = (CustomPlaybackControlView) findViewById(R.id.exo_controller);
  ...
  public CustomPlaybackControlView getUseControllerView() {
    return controller;
  }
