 ...
 * 作    者 : FLY
 * 创建时间 : 2018/9/6
 * 描述: 星期栏，如果你要使用星期栏自定义，切记XML使用 merge，不要使用LinearLayout
 */
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.fly.viewlibrary.calendar.WeekBar".equals(getClass().getName())) {
            LayoutInflater.from(context).inflate(R.layout.calendar_week_bar, this, true);
        }
    }
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.fly.viewlibrary.calendar.WeekBar".equalsIgnoreCase(getClass().getName())) {
